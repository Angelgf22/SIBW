<?php
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if(isset($_FILES['portada'])){
                ...
                if(sizeof($errors) === 0)
                    $id = insertEvento($titulo, $episodios, $temporadas, $fecha, $contenido, $generos, $link, $portada);
                    $id_global= $id;
            }

            if($_FILES['portada']['name'] === '')
                $id = insertEventoSinPortada($titulo, $episodios, $temporadas, $fecha, $contenido, $generos, $link);
                $id_global= $id;
                        ...
                        if(isset($_FILES['galeria1'])){
                            ...
                            if(sizeof($errors) === 0)
                               actualizarImagen($galeria1, $id, 0);
                        ...
                        if(isset($_FILES['galeria2'])){
                            ...
                            if(sizeof($errors) === 0)
                                actualizarImagen($galeria2, $id, 1);
                        }
